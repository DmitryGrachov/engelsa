...
import { formatFavoritesInCountLine } from './account-modal-utils.js';
import './desk/account-desk-favorites-card.js';
import './desk/account-desk-favorites-sort.js';
import './desk/account-desk-favorites-user-menu.js';
...
/** @typedef {'all' | 'apartments'} AccountDeskFavoritesTab */

class AccountDeskView extends BaseElement {
    static properties = {
    ...
    _onMortgageClick() {
        this._emit('account-mortgage-calculator');
    }

    _onOffersClick() {
        this._emit('account-desk-favorites-offers');
    }
        ...
        return html`
            <div class="accountDeskView" part="root">
                            ...
                            ${this.userMenuOpen
                                ? html`
                                    <div class="accountDeskFavoritesUserMenuLayer">
                                        ...
                                        ></button>
                                        <account-desk-favorites-user-menu
                                            class="accountDeskFavoritesUserMenuHost"
                                            user-id=${this.userId}
                                            @account-desk-favorites-user-menu-close=${this._closeUserMenu}
                                        ></account-desk-favorites-user-menu>
                                    </div>
                                `
                                : null}
                ...
                <div class="accountDeskFavoritesHeadline">
                    <h1 class="accountDeskFavoritesTitle">Избранное</h1>
                    <p class="accountDeskFavoritesSubtitle">Ваши сохранения:</p>
                </div>

                <div class="accountDeskFavoritesTabs" role="tablist" aria-label="Категории избранного">
                    <button
                        type="button"
                    ...
                    ? html`
                        <div class="accountDeskFavoritesToolbar">
                            <div class="accountDeskFavoritesToolbarLeft">
                                <div class="accountDeskFavoritesSectionHead">
                                    ...
                                    <p class="accountDeskFavoritesSectionCount">
                                        ${formatFavoritesInCountLine(this.apartmentsCount)}
                                    </p>
                                </div>
                            ...
                            <div class="accountDeskFavoritesToolbarRight">
                                ...
                                <button
                                    type="button"
                                    class="accountDeskFavoritesCompareBtn"
                                    @click=${this._onCompareClick}
                                >
                                    В Лист сравнения ${compareCount}/${COMPARE_SLOT_MAX}
                                </button>
                            </div>
                        </div>
...
registerComponent('account-desk-view', AccountDeskView);

export { AccountDeskView, COMPARE_SLOT_MAX };
