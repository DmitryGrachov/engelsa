...
class ComparisonsDeskUserMenu extends BaseElement {
    static properties = {
    ...
    _onCloseClick() {
        this.dispatchEvent(new CustomEvent('comparisons-desk-user-menu-close', {
            bubbles: true
        }));
    }
    ...
    /** @param {string} itemId */
    _onItemClick(itemId) {
        this.dispatchEvent(new CustomEvent('comparisons-desk-user-menu-item', {
            bubbles: true,
            detail: { itemId }
        }));
        this._onCloseClick();
...
registerComponent('comparisons-desk-user-menu', ComparisonsDeskUserMenu);

export { ComparisonsDeskUserMenu };
