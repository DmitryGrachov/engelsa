...
import './filter-mob-card-tags.js';
import './filter-mob-card-plan.js';

class FilterResultsPlanCard extends BaseElement {
    static properties = {
        title: { type: String },
    ...
    render() {
        ...
        return html`
            <article class="filterMobCard filterResultsPlanCard" part="card">
...
registerComponent('filter-results-plan-card', FilterResultsPlanCard);

export { FilterResultsPlanCard };
